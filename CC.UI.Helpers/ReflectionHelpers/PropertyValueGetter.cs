...
namespace CC.Core.Utilities
{
    public class PropertyValueGetter : IValueGetter
    {
        ...
        {
            MemberExpression memberExpression = Expression.Property(body, _propertyInfo);
        ...
        public bool Equals(PropertyValueGetter other)
        {
            ...
            return other._propertyInfo.DeclaringType == _propertyInfo.DeclaringType &&
                   other._propertyInfo.Name == _propertyInfo.Name;
        }
